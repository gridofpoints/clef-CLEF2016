...
/**
 * Weak (light) Czech stemmer (original taken from
 ...
 * 
 */
public class WeakCzechStemmer extends StemmerTermPipeline {
	 ...
	 * @param next
	 */
	public WeakCzechStemmer(TermPipeline next) {
		super(next);
	}
