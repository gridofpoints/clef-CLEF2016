...
/**
 * Italian weak stemmer (original taken from
 ...
 * 
 */
public class WeakItalianStemmer extends StemmerTermPipeline {
	/**
	 * constructor
	 */
	public WeakItalianStemmer() {
		super();
	}
	 ...
	 * @param next
	 */
	public WeakItalianStemmer(TermPipeline next) {
		super(next);
	}
