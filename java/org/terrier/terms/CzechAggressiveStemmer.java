...
/**
 * Czech (aggressive) stemmer (original taken from
 ...
 * 
 */
public class CzechAggressiveStemmer extends StemmerTermPipeline {
	 ...
	 * @param next
	 */
	public CzechAggressiveStemmer(TermPipeline next) {
		super(next);
	}
	...
	private void removeDerivational(StringBuffer buffer) {
		...
		if (len > 7) {
			...
			if (buffer.substring(len - 5, len).equals("ovisk") || buffer.substring(len - 5, len).equals("ovstv")
		...
		if (len > 6) {
			if (buffer.substring(len - 4, len).equals("\u00e1sek") || // -ásek
					buffer.substring(len - 4, len).equals("loun") || buffer.substring(len - 4, len).equals("nost")
					|| buffer.substring(len - 4, len).equals("teln") || buffer.substring(len - 4, len).equals("ovec")
					|| buffer.substring(len - 5, len).equals("ov\u00edk") || // -ovík
					buffer.substring(len - 4, len).equals("ovtv") || buffer.substring(len - 4, len).equals("ovin")
					|| buffer.substring(len - 4, len).equals("\u0161tin")) { // -štin

				buffer.delete(len - 4, len);
				return;
			}
			if (buffer.substring(len - 4, len).equals("enic") || buffer.substring(len - 4, len).equals("inec")
		...
		if (len > 5) {
			...
			if (buffer.substring(len - 3, len).equals("i\u00e1n") || // -ián
					buffer.substring(len - 3, len).equals("ist") || buffer.substring(len - 3, len).equals("isk")
					|| buffer.substring(len - 3, len).equals("i\u0161t") || // -išt
					buffer.substring(len - 3, len).equals("itb") || buffer.substring(len - 3, len).equals("\u00edrn")) { // -írn

				buffer.delete(len - 2, len);
				palatalise(buffer);
				return;
			}
			if (buffer.substring(len - 3, len).equals("och") || buffer.substring(len - 3, len).equals("ost")
					|| buffer.substring(len - 3, len).equals("ovn") || buffer.substring(len - 3, len).equals("oun")
			...
			if (buffer.substring(len - 3, len).equals("kyn") || buffer.substring(len - 3, len).equals("\u010dan") || // -čan
					...
					buffer.substring(len - 3, len).equals("ctv") || buffer.substring(len - 3, len).equals("stv")) {
		...
		if (len > 4) {
			if (buffer.substring(len - 2, len).equals("\u00e1\u010d") || // -áč
					...
					buffer.substring(len - 2, len).equals("an") || buffer.substring(len - 2, len).equals("\u00e1\u0159")
					|| // -ář
			...
			if (buffer.substring(len - 2, len).equals("ec") || buffer.substring(len - 2, len).equals("en")
			...
			if (buffer.substring(len - 2, len).equals("\u00ed\u0159") || // -íř
					buffer.substring(len - 2, len).equals("ic") || buffer.substring(len - 2, len).equals("in")
					|| buffer.substring(len - 2, len).equals("\u00edn") || // -ín
					buffer.substring(len - 2, len).equals("it") || buffer.substring(len - 2, len).equals("iv")) {
			...
			if (buffer.substring(len - 2, len).equals("ob") || buffer.substring(len - 2, len).equals("ot")
			...
			if (buffer.substring(len - 2, len).equals("\u010dk") || // -čk
					...
					buffer.substring(len - 2, len).equals("dl") || buffer.substring(len - 2, len).equals("nk")
					|| buffer.substring(len - 2, len).equals("tv") || buffer.substring(len - 2, len).equals("tk")
		...
		if (len > 3) {
			if (buffer.charAt(buffer.length() - 1) == 'c' || buffer.charAt(buffer.length() - 1) == '\u010d' || // -č
					buffer.charAt(buffer.length() - 1) == 'k' || buffer.charAt(buffer.length() - 1) == 'l'
					|| buffer.charAt(buffer.length() - 1) == 'n' || buffer.charAt(buffer.length() - 1) == 't') {
	...
	private void removeAugmentative(StringBuffer buffer) {
		...
		if ((len > 5)
				&& (buffer.substring(len - 3, len).equals("izn") || buffer.substring(len - 3, len).equals("isk"))) {

			buffer.delete(len - 2, len);
			palatalise(buffer);
			return;
		}
		if ((len > 4) && buffer.substring(len - 2, len).equals("\00e1k")) { // -ák
	...
	private void removeDiminutive(StringBuffer buffer) {
		int len = buffer.length();
		//
		if ((len > 7) && buffer.substring(len - 5, len).equals("ou\u0161ek")) { // -oušek
		...
		if (len > 6) {
			if (buffer.substring(len - 4, len).equals("e\u010dek") || // -eček
					...
					buffer.substring(len - 4, len).equals("enek") || buffer.substring(len - 4, len).equals("\u00e9nek")
					|| // -ének
			...
			if (buffer.substring(len - 4, len).equals("\u00e1\u010dek") || // áček
					...
					buffer.substring(len - 4, len).equals("anek") || buffer.substring(len - 4, len).equals("onek")
		...
		if (len > 5) {
			...
			if (buffer.substring(len - 3, len).equals("\u00e1\u010dk") || // -áčk
					...
					buffer.substring(len - 3, len).equals("ank") || buffer.substring(len - 3, len).equals("onk")
		...
		if (len > 4) {
			if (buffer.substring(len - 2, len).equals("ek") || buffer.substring(len - 2, len).equals("\u00e9k") || // -ék
			...
			if (buffer.substring(len - 2, len).equals("\u00e1k") || // -ák
					buffer.substring(len - 2, len).equals("ak") || buffer.substring(len - 2, len).equals("ok")
	...
	private void removeComparative(StringBuffer buffer) {
		int len = buffer.length();
		//
		if ((len > 5) && (buffer.substring(len - 3, len).equals("ej\u0161") || // -ejš
		...
		if (len > 5) {
			...
			if (buffer.substring(len - 3, len).equals("\u00e9ho") || // -ého
					...
					buffer.substring(len - 3, len).equals("emi") || buffer.substring(len - 3, len).equals("\u00e9mu") || // -ému
																															// buffer.substring(
																															// len-3,len).equals("ete")||
					buffer.substring(len - 3, len).equals("eti") || buffer.substring(len - 3, len).equals("iho")
