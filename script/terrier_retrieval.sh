...
indexNames["AH-MONO-EN-TREC1997"]=en_tipster_9799;
indexNames["AH-MONO-EN-TREC1998"]=en_tipster_9799;
indexNames["AH-MONO-EN-TREC1999"]=en_tipster_9799;
...
declare -a stemmers=(wkstem agstem nolug);

## declare the rank models array
declare -a models=("BB2" "BM25" "DFIZ" "DFRee" "DirichletLM" "DLH" "DPH" "Hiemstra_LM" "IFB2" "InB2" "In_expB2" "Js_KLs" "InL2" "LemurTF_IDF" "LGD" "PL2" "TF_IDF");

## declare the ltr array
declare -a ltr=("noltr");

## declare the topic field array
declare -a tfield=("medium");
				...
				do
					...
					if [ "$st" == "${stemmers[0]}" -o "$st" == "${stemmers[1]}" ]; then
						...
						do
							...
							runTag="$indexName"_"$modelName"_"$learning"_"$tf";
