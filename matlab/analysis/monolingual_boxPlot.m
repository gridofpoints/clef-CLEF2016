...
ah_mono_bg_2005 = mean(ap_AH_MONO_BG_CLEF2005{:,:});
ah_mono_bg_2006 = mean(ap_AH_MONO_BG_CLEF2006{:,index_noqe});
ah_mono_bg_2007 = mean(ap_AH_MONO_BG_CLEF2007{:,index_noqe});

ah_mono_de_2000 = mean(ap_AH_MONO_DE_CLEF2000{:,index_noqe});
ah_mono_de_2001 = mean(ap_AH_MONO_DE_CLEF2001{:,index_noqe});
ah_mono_de_2002 = mean(ap_AH_MONO_DE_CLEF2002{:,index_noqe});
ah_mono_de_2003 = mean(ap_AH_MONO_DE_CLEF2003{:,index_noqe});

ah_mono_es_2001 = mean(ap_AH_MONO_ES_CLEF2001{:,index_noqe});
ah_mono_es_2002 = mean(ap_AH_MONO_ES_CLEF2002{:,index_noqe});
ah_mono_es_2003 = mean(ap_AH_MONO_ES_CLEF2003{:,index_noqe});

ah_mono_fi_2002 = mean(ap_AH_MONO_FI_CLEF2002{:,index_noqe});
ah_mono_fi_2003 = mean(ap_AH_MONO_FI_CLEF2003{:,index_noqe});
ah_mono_fi_2004 = mean(ap_AH_MONO_FI_CLEF2004{:,index_noqe});

ah_mono_fr_2000 = mean(ap_AH_MONO_FR_CLEF2000{:,index_noqe});
ah_mono_fr_2001 = mean(ap_AH_MONO_FR_CLEF2001{:,index_noqe});
ah_mono_fr_2002 = mean(ap_AH_MONO_FR_CLEF2002{:,index_noqe});
ah_mono_fr_2003 = mean(ap_AH_MONO_FR_CLEF2003{:,index_noqe});
ah_mono_fr_2004 = mean(ap_AH_MONO_FR_CLEF2004{:,index_noqe});
ah_mono_fr_2005 = mean(ap_AH_MONO_FR_CLEF2005{:,index_noqe});
ah_mono_fr_2006 = mean(ap_AH_MONO_FR_CLEF2006{:,index_noqe});

ah_mono_it_2000 = mean(ap_AH_MONO_IT_CLEF2000{:,index_noqe});
ah_mono_it_2001 = mean(ap_AH_MONO_IT_CLEF2001{:,index_noqe});
ah_mono_it_2002 = mean(ap_AH_MONO_IT_CLEF2002{:,index_noqe});
ah_mono_it_2003 = mean(ap_AH_MONO_IT_CLEF2003{:,index_noqe});

ah_mono_pt_2004 = mean(ap_AH_MONO_PT_CLEF2004{:,index_noqe});
ah_mono_pt_2005 = mean(ap_AH_MONO_PT_CLEF2005{:,index_noqe});
ah_mono_pt_2006 = mean(ap_AH_MONO_PT_CLEF2006{:,index_noqe});

ah_mono_hu_2005 = mean(ap_AH_MONO_HU_CLEF2005{:,index_noqe});
ah_mono_hu_2006 = mean(ap_AH_MONO_HU_CLEF2006{:,index_noqe});
ah_mono_hu_2007 = mean(ap_AH_MONO_HU_CLEF2007{:,index_noqe});

ah_mono_ru_2003 = mean(ap_AH_MONO_RU_CLEF2003{:,1:2:256});
ah_mono_ru_2004 = mean(ap_AH_MONO_RU_CLEF2004{:,1:2:192});

ah_mono_sv_2002 = mean(ap_AH_MONO_SV_CLEF2002{:,index_noqe});
ah_mono_sv_2003 = mean(ap_AH_MONO_SV_CLEF2003{:,index_noqe});
...
title('CLEF Adhoc Monolingual Tasks (2000 - 2007) - MAP Distribution', 'FontName', 'Helvetica Light', 'FontSize', 14);
