...
if (strcmpi(computer, 'GLNXA64'))
    ...
    EXPERIMENT.path.base = '/Users/silvello/Dropbox/Papers/CLEF2016-FS/code/experiments/';
end;
...
EXPERIMENT.taxonomy.stop.id = {'nostop', 'stop'};
...
EXPERIMENT.taxonomy.stem.id = {'nostem', 'agstem', 'wkstem'};
EXPERIMENT.taxonomy.stem.name = 'Stemmers';
EXPERIMENT.taxonomy.stem.number = length(EXPERIMENT.taxonomy.stem.id);

EXPERIMENT.taxonomy.lugall.id = {'nostem', 'agstem', 'wkstem', '4grams', '5grams'};
EXPERIMENT.taxonomy.lugall.name = 'lug';
...
EXPERIMENT.taxonomy.model.name = 'Model';
...
% CLEF 2005 BG
EXPERIMENT.AH_MONO_BG_CLEF2005.id = 'AH_MONO_BG_CLEF2005';
EXPERIMENT.AH_MONO_BG_CLEF2005.name =  'CLEF 2005, BG, Adhoc';

EXPERIMENT.AH_MONO_FR_CLEF2003.id = 'AH_MONO_FR_CLEF2003';
EXPERIMENT.AH_MONO_FR_CLEF2003.name =  'CLEF 2003, French, Adhoc';

EXPERIMENT.AH_MONO_DE_CLEF2001.id = 'AH_MONO_DE_CLEF2001';
EXPERIMENT.AH_MONO_DE_CLEF2001.name =  'CLEF 2001, German, Adhoc';
...
EXPERIMENT.analysis.fourF.id = 'fourF';
EXPERIMENT.analysis.fourF.name = 'fourFactor';
EXPERIMENT.analysis.fourF.description = 'Four factors, repeated measures, mixed crossed effects GLMM: topics are random effects (repeated measures/within-subject), stop lists, stemmers and/or n-grams, IR models, and measures are fixed effects';
EXPERIMENT.analysis.fourF.command = @(measures, lugType) ( fourFactorRepeatedMeasuresMixedCrossedEffects(lugType, measures{:}) );
EXPERIMENT.analysis.fourF.measure.id = 'all';
