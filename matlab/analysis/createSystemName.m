...
function [name] = createSystemName(stop, stem, model)
    if (strcmp(stem,'nostem'))
        name = sprintf('%1$s_nograms_%2$s_%3$s_noqe_td', stop, stem, model);
    elseif (strcmp(stem,'nograms'))
            name = sprintf('%1$s_%2$s_nostem_%3$s_noqe_td', stop, stem, model);
    elseif (strcmp(stem,'4grams') || strcmp(stem,'5grams'))
            name = sprintf('%1$s_%2$s_nostem_%3$s_noqe_td', stop, stem, model);
    else
        name = sprintf('%1$s_nograms_%2$s_%3$s_noqe_td', stop, stem, model);
    end
